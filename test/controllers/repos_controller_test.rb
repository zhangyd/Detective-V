...
class ReposControllerTest < ActionController::TestCase
  ...
  test "should create repo" do
    assert_difference('Repo.count') do
      post :create, repo: { description: @repo.description, full_name: @repo.full_name, html_url: @repo.html_url, language: @repo.language, name: @repo.name, owner: @repo.owner, size: @repo.size }
    end
  ...
  test "should update repo" do
    patch :update, id: @repo, repo: { description: @repo.description, full_name: @repo.full_name, html_url: @repo.html_url, language: @repo.language, name: @repo.name, owner: @repo.owner, size: @repo.size }
    assert_redirected_to repo_path(assigns(:repo))
  end
